...
export default function Alert({ type = "success", message }) {
	...
	return (
		<div
			style={style}
			className="z-40 border-l-4 border-current animate-fade-in-right absolute top-2 right-4 max-w-xs flex items-center px-6 py-4 mb-4 text-sm rounded-lg shadow-md"
			role="alert">
			<svg
